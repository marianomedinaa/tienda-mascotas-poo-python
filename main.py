...
# Una tienda de mascotas local llamadas "Patas Felices"
# quiere modernizar su sistema de gestión.
# Actualmente, llevan un registro manual de sus
# mascotas, clientes y ventas, lo cual es muy ineficiente
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Saliendo del sistema ¡Gracias por usar Pata Felices APP!")
            break
        else:
